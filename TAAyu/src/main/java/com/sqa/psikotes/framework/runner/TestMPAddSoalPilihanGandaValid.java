...
public class TestMPAddSoalPilihanGandaValid {
	...
	public void tsmp009_admin_input_soal_pilihan_a_pilihan_b_pilihan_c_pilihan_d_pilihan_e_kunci_jawaban_dan_file_gambar(String kunciJawaban, String gambar) {
	    modulPage.clickFieldGambar(kunciJawaban, gambar);
